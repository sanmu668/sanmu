...
const contactLinks = computed(() => ({
  email: `mailto:${props.person.contact.email}`,
  github: `https://github.com/${props.person.contact.github}`,
  linkedin: `https://linkedin.com/in/${props.person.contact.linkedin}`,
  medium: `https://medium.com/@${props.person.contact.medium}`
}))
</script>
